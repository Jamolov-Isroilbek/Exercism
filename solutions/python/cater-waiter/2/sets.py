...
def categorize_dish(dish_name, dish_ingredients):
    ...
    dish_name_set = set(dish_ingredients)
    
    if dish_name_set.issubset(VEGAN):
        dish_category = 'VEGAN'
    elif dish_name_set.issubset(VEGETARIAN):
        dish_category = 'VEGETARIAN'
    elif dish_name_set.issubset(PALEO):
        dish_category = 'PALEO'
    elif dish_name_set.issubset(KETO):
        dish_category = 'KETO'
    elif dish_name_set.issubset(OMNIVORE):
...
def tag_special_ingredients(dish):
    ...
    special_ingredients_set = set(dish[1]).intersection(SPECIAL_INGREDIENTS)
